...
\begin{figure}[h!]
        ...
        \begin{subfigure}[b]{\textwidth}
			...
			\centering
			\resizebox{0.9\textwidth}{!}{\input{jedna_szczelina}}		
...
\caption{Położenia maksimów i minimów natężenia światła}
	\begin{tabular}{|C{2cm}|C{2cm}|C{2cm}|C{2cm}|C{2cm}|}\hline
		Numer maksimum $|m|$ & Położenie z lewej $x_l$ [mm] & Położenie z prawej $x_p$ [mm] & $x = \frac{x_p-x_l}{2}$ [mm] & Obliczona odległość $d$ [mm] \\ \hline
		1 & -1,3 & 1,3 & 1,3 & $0,539$\\ \hline
		2 & -4,1 & 4,1 & 4,1 & $0,5283$ \\ \hline
		3 & -5,8 & 5,6 & 5,7 &  $0,5127$ \\ \hline
		4 & -7,0 & 6,9 & 6,95 & $0,5143$\\ \hline
	\end{tabular}
